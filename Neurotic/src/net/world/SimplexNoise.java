...
public class SimplexNoise { // Simplex noise in 2D, 3D and 4D
	private static Vector grad3[] = { new Vector(1, 1, 0), new Vector(-1, 1, 0), new Vector(1, -1, 0), new Vector(-1, -1, 0),
			new Vector(1, 0, 1), new Vector(-1, 0, 1), new Vector(1, 0, -1), new Vector(-1, 0, -1), new Vector(0, 1, 1),
			new Vector(0, -1, 1), new Vector(0, 1, -1), new Vector(0, -1, -1) };

	private static Vector grad4[] = { new Vector(0, 1, 1, 1), new Vector(0, 1, 1, -1), new Vector(0, 1, -1, 1),
			new Vector(0, 1, -1, -1), new Vector(0, -1, 1, 1), new Vector(0, -1, 1, -1), new Vector(0, -1, -1, 1),
			new Vector(0, -1, -1, -1), new Vector(1, 0, 1, 1), new Vector(1, 0, 1, -1), new Vector(1, 0, -1, 1),
			new Vector(1, 0, -1, -1), new Vector(-1, 0, 1, 1), new Vector(-1, 0, 1, -1), new Vector(-1, 0, -1, 1),
			new Vector(-1, 0, -1, -1), new Vector(1, 1, 0, 1), new Vector(1, 1, 0, -1), new Vector(1, -1, 0, 1),
			new Vector(1, -1, 0, -1), new Vector(-1, 1, 0, 1), new Vector(-1, 1, 0, -1), new Vector(-1, -1, 0, 1),
			new Vector(-1, -1, 0, -1), new Vector(1, 1, 1, 0), new Vector(1, 1, -1, 0), new Vector(1, -1, 1, 0),
			new Vector(1, -1, -1, 0), new Vector(-1, 1, 1, 0), new Vector(-1, 1, -1, 0), new Vector(-1, -1, 1, 0),
			new Vector(-1, -1, -1, 0) };
	...
	private static double dot(Vector g, double x, double y, double z) {
		return g.x * x + g.y * y + g.z * z;
	}

	private static double dot(Vector g, double x, double y, double z, double w) {
